...
<body>
  ...
  <nav class="w3-sidenav w3-white w3-card-2 w3-animate-top w3-center" style="display:none;padding-top:150px" id="mySidenav">
    ...
    <!-- Footer -->
    <div class="w3-center">
      <a href="#" class="w3-show-inline-block"><i class="fa fa-facebook w3-text-indigo fa-2x"></i></a>
      <a href="#" class="w3-show-inline-block"><i class="fa fa-twitter w3-text-blue fa-2x"></i></a>
      <a href="#" class="w3-show-inline-block"><i class="fa fa-youtube w3-text-red fa-2x"></i></a>
      <a href="#">Quem somos</a>
      <a href="#">Sobre DOAR</a>
