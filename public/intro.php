    ...
    <div class="filter backimg">
      <div class="w3-col l3 s12" style="float: none; margin: 0 auto">
        ...
        <div class="w3-container w3-center">
            <a href="login.php" class="w3-text-white w3-opacity">Iniciar Sessão</a> <b class="w3-text-green">|</b> <a href="#" class="w3-text-white w3-opacity">Não possuo conta</a>
        </div>
      </div>
    </div>
      ...
      <div class="filter">
        ...
        <div class="w3-half">
          <form class="w3-form w3-transparent" action="index.html" method="post">
            ...
            <input type="submit" name="name" value="Enviar agora" class="w3-btn w3-margin-top w3-transparent w3-border ">
          </form>
        </div>
        </div>
      </div>
